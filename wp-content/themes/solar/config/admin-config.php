...
foreach ($google_fonts as $font) {
    $fonts[] = array($font['name'], 'tk_font_' . $font['name'] . $font['variant']);
}
    ...
    array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'value' => '',
                'label' => 'Header Logo',
                'desc' => 'JPEG, GIF or PNG image, recommended up to 500KB',
            ),
            array(
                'id' => 'box_1_hr',
                'name' => 'box_1_hr',
            ...
            array(
                ...
                'name' => 'footer_copy',
                'type' => 'text',
                'value' => 'Copyright Information Goes Here 2014. All Rights Reserved.',
    ...
    array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'desc' => 'Enter Pinterest account (e.g. themeskingdom) or leave empty if you dont wish to use Instagram',
                'options' => array(
                    'size' => '80'
                )
            ),
            array(
                ...
                'type' => 'text',
                'value' => '',
                'label' => 'Behance account',
                'desc' => 'Enter Behance account (e.g. themeskingdom) or leave empty if you dont wish to use Behance',
                'options' => array(
                    'size' => '80'
                )
            ),
            array(
                ...
                'desc' => 'Enter Dribbble account (e.g. themeskingdom) or leave empty if you dont wish to use Dribbble',
                'options' => array(
                    'size' => '80'
                )
            ),
            ...
            array(
                ...
                'type' => 'text',
                'value' => '',
                'label' => 'Vimeo account id',
                'desc' => 'Enter Vimeo account id (e.g. user91157089) or leave empty if you dont wish to use Vimeo',
                'options' => array(
                    'size' => '80'
                )
            ),
            ...
            /*array(
                'id' => 'social_share_gallery',
                'name' => 'social_share_gallery',
                'type' => 'checkbox',
                'options' => array(
                    'yes' => 'If checked social share buttons will be disabled in a single gallery post.'
                ),
                'label' => 'Disable Gallery Post Share buttons',
                'desc' => '',
                'value' => '',
            ),*/
    ...
    array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'type' => 'checkbox',
                'options' => array(
                    'yes' => 'If checked map colors will be used'
                ),
